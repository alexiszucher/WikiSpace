...
<h2>Composants JavaScript</h2>


<div id="INTEGRER GOOGLE MAP AVEC LEAFLET">
    <b>INTEGRER GOOGLE MAP AVEC LEAFLET</b>
    <br /><br />
...
<div id="CREATION DASHBOARD GLISSER-DEPOSER">
    <b>CREATION DASHBOARD GLISSER-DEPOSER</b>
    <br /><br />
    <textarea cols="150" rows="20">
        Utiliser GridStack (A compléter)
    </textarea>
</div>
